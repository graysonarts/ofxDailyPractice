...
glm::vec3 JzAzBzColor::to_srgb() {
    double jz = value.x * 0.16717463120366200 + 1.6295499532821566e-11;
    double cz = value.y * 0.16717463120366200;
    double hz = value.z * 6.28318530717958647 + -3.14159265358979323;
